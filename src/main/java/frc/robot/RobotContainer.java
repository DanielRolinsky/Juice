...
import frc.robot.commands.AimLimelightCommand;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    new JoystickButton(masterController, 1).whenPressed(new AimLimelightCommand(driveSubsystem, limelightSubsystem));
  }
